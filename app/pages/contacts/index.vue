<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="text-center mb-10">
      <h1 class="text-4xl font-bold mb-3">Контакты</h1>
        ...
        <div class="card-body p-5 sm:p-6">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-12 h-12 bg-base-200 rounded-xl flex items-center justify-center">
              <Icon name="heroicons:envelope" class="w-6 h-6 text-base-content" />
            </div>
            <div>
          ...
          <form class="space-y-3">
            ...
            <div class="w-full">
              <div class="label">
                <span class="label-text font-medium">Сообщение</span>
              </div>
              <textarea
id="contact-message"
                class="textarea textarea-bordered w-full h-32 resize-none focus:textarea-secondary"
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body p-6 sm:p-8">
            <div class="flex items-center gap-3 mb-6">
              <div class="w-12 h-12 bg-base-200 rounded-xl flex items-center justify-center">
                <Icon name="heroicons:building-office-2" class="w-6 h-6 text-base-content" />
              </div>
              <h2 class="text-xl font-bold">Контактная информация</h2>
            </div>

            <div class="space-y-4">
              <div class="flex items-start gap-4 p-3 rounded-lg hover:bg-base-200 transition-colors">
                <div class="w-10 h-10 bg-success/10 rounded-lg flex items-center justify-center shrink-0">
                  <Icon name="heroicons:phone" class="w-5 h-5 text-success" />
                </div>
                <div>
                  <p class="text-sm text-base-content/60">
                    Телефон горячей линии
                  </p>
                  <a href="tel:88007707999" class="font-semibold text-lg transition-colors">
                    8 (800) 770-79-99
                  </a>
              ...
              <div class="flex items-start gap-4 p-3 rounded-lg hover:bg-base-200 transition-colors">
                <div class="w-10 h-10 bg-info/10 rounded-lg flex items-center justify-center shrink-0">
                  <Icon name="heroicons:envelope" class="w-5 h-5 text-info" />
                </div>
                <div>
                  <p class="text-sm text-base-content/60">Email</p>
                  <a href="mailto:info@dns-shop.ru" class="font-semibold transition-colors">
                    info@dns-shop.ru
                  </a>
                </div>
              </div>
              ...
              <div class="flex items-start gap-4 p-3 rounded-lg hover:bg-base-200 transition-colors">
                <div class="w-10 h-10 bg-warning/10 rounded-lg flex items-center justify-center shrink-0">
                  <Icon name="heroicons:map-pin" class="w-5 h-5 text-warning" />
                </div>
                <div>
                  <p class="text-sm text-base-content/60">Адрес офиса</p>
                  <p class="font-semibold">ул. Городская, 24</p>
                  <p class="text-sm text-base-content/70">
                    п. Троицк, Москва, 108841
                  </p>
                </div>
              </div>

              <div class="flex items-start gap-4 p-3 rounded-lg hover:bg-base-200 transition-colors">
                <div class="w-10 h-10 bg-error/10 rounded-lg flex items-center justify-center shrink-0">
                  <Icon name="heroicons:clock" class="w-5 h-5 text-error" />
                </div>
                <div>
                  <p class="text-sm text-base-content/60">График работы</p>
                  <p class="font-semibold">Ежедневно с 10:00 до 21:00</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body p-0">
            <div class="p-4 pb-0 flex items-center gap-3">
              <div class="w-10 h-10 bg-base-200 rounded-lg flex items-center justify-center">
                <Icon name="heroicons:map" class="w-5 h-5 text-base-content" />
              </div>
              <h2 class="font-bold">Как нас найти</h2>
            </div>
